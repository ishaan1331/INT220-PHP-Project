...
<?php endif; ?>
    ...
    <img src="<?= asset('Assets\Solo page\goa.jpg') ?>" class="custom-page" alt="... ">
    ...
    <p class="custom-page-list-para">
        ...
        <ul class="custom-page-list">
            ...
            <li>Day 1 - Sightseeing and Watersports at Baga beach<br>
                <img src="<?= asset('Assets\Solo page\Goa\baga-sea-beach.jpg') ?>" class="custom-page-image " alt="... ">
            </li>


            <li>Day 2 - Palolem Beach visit and nearby church sightseeings<br>
                <img src="<?= asset('Assets\Solo page\Goa\palolem.jpg') ?>" class="custom-page-image " alt="... ">
            </li>

            <li>Day 3 - Exploring Calangute (alongwith shopping and seafood)<br>
                <img src="<?= asset('Assets\Solo page\Goa\calangute.jpg') ?>" class="custom-page-image " alt="... ">
            </li>

            <li>Day 4 - Shopping at The Saturday Night Market , Arpora<br>
                <img src="<?= asset('Assets\Solo page\Goa\arpora.jpg') ?>" class="custom-page-image " alt="... ">
            </li>
                ...
                <div id="carouselExampleControls" class="carousel slide custom-page-image" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= asset('Assets\Solo page\Goa\baga-sea-beach.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
    ...
    <p class="custom-page-list-para bottom">
        ...
        <p class="custom-page-div-font bottom ">
            70,000 /- INR (Including overall hotel stays , vehicle charges and food at the best restaurants )
...
<?php /**PATH C:\Users\hp\Documents\Laravel\Tourism\resources\views/goa.blade.php ENDPATH**/ ?>
        ...
        <div class="tab-content" id="nav-tabContent">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 card-padding " style="margin: 0px;">
                    <div class="col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/polonnaruwa')); ?>">
                    ...
                    <div class="col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/goa')); ?>">
                    ...
                    <div class="col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/kasol')); ?>">
                    ...
                    <div class="col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/varkala')); ?>">
                    ...
                    <div class="col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/bali')); ?>">
                    ...
                    <div class="col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/bangkok')); ?>">
            ...
            <div class="tab-pane fade " id="nav-honeymoon" role="tabpanel " aria-labelledby="nav-honeymoon-tab">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 card-padding " style="margin: 0px;">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/santorini')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/maldives')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/mauritius')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/paris')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/venice')); ?>">
            ...
            <div class="tab-pane fade " id="nav-group" role="tabpanel " aria-labelledby="nav-group-tab">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 card-padding " style="margin: 0px;">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/ladakh')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/dubai')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/vegas')); ?>">
            ...
            <div class="tab-pane fade " id="nav-adventure" role="tabpanel " aria-labelledby="nav-adventure-tab">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 card-padding " style="margin: 0px;">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/rishikesh')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/iceland')); ?>">
                    ...
                    <div class=" col ">
                        <div class="card h-100 ">
                            <a href="<?php echo e(url('categories/brazil')); ?>">
...
<?php /**PATH C:\Users\hp\Documents\Laravel\Tourism\resources\views/categories.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
    ...
    <img src="<?= asset('Assets\Solo page\varkala.jpg') ?>" class="custom-page" alt="... ">
    ...
    <p class="custom-page-list-para">
        ...
        <ul class="custom-page-list">
            ...
            <li>Day 1 - Lazying in Varkala Beach<br>
                <img src="<?= asset('Assets/Solo page/Varkala/varkala-beach.jpg') ?>" class="custom-page-image">
            </li>


            <li>Day 2 - Seek blessings at Janardhana Swami Temple and Shopping<br>
                <img src="<?= asset('Assets/Solo page/Varkala/varkala 2.jpg') ?>" class="custom-page-image">
            </li>

            <li>Day 3 - Sightseeing from Varkala Lighthouse<br>
                <img src="<?= asset('Assets/Solo page/Varkala/varkala3.jpg') ?>" class="custom-page-image">
            </li>

            <li>Day 3 - Boating in Kappil Lake<br>
                <img src="<?= asset('Assets/Solo page/Varkala/varkala4.jpg') ?>" class="custom-page-image">
            </li>

            <li>During the trip , we would stay at The Palm Tree Heritage<br>
                <div id="carouselExampleControls" class="carousel slide custom-page-image" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= asset('Assets/Solo page/Varkala/varkala6.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets/Solo page/Varkala/varkala5.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets/Solo page/Varkala/varkala7.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets/Solo page/Varkala/varkala8.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                    </div>
    ...
    <p class="custom-page-list-para bottom">
        ...
        <p class="custom-page-div-font bottom ">
            50,000 /- INR (Including overall hotel stays , vehicle charges and food at the best restaurants )
...
<?php /**PATH C:\Users\hp\Documents\Laravel\Tourism\resources\views/varkala.blade.php ENDPATH**/ ?>
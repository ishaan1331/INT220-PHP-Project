...
<?php endif; ?>
    ...
    <img src="<?= asset('Assets\Solo page\kasol.jpg') ?>" class="card-img-top custom-page" alt="... ">
    ...
    <p class="custom-page-list-para">
        ...
        <ul class="custom-page-list">
            ...
            <li>Day 1-5 - Sar Pass Trek (13850 ft)<br>
                <img src="<?= asset('Assets\Solo page\kasol\kasol.jpg') ?>" class="custom-page-image">
            </li>


            <li>Day 6 - Seeing the Parvati River<br>
                <img src="<?= asset('Assets\Solo page\kasol\kasol2.jpg') ?>" class="custom-page-image">
            </li>

            <li>Day 7 - Exploring Malana<br>
                <img src="<?= asset('Assets\Solo page\kasol\kasol3.jpg') ?>" class="custom-page-image">
            </li>

            <li>During the trip , we would stay at Parvati Kuteer <br>
                <div id="carouselExampleControls" class="carousel slide custom-page-image" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= asset('Assets\Solo page\kasol\kasol4.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets\Solo page\kasol\kasol5.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets\Solo page\kasol\kasol6.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets\Solo page\kasol\kasol7.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                    </div>
    ...
    <p class="custom-page-list-para bottom">
        ...
        <p class="custom-page-div-font bottom ">
            40,000 /- INR (Including overall hotel stays , vehicle charges and food at the best restaurants )
...
<?php /**PATH C:\Users\hp\Documents\Laravel\Tourism\resources\views/kasol.blade.php ENDPATH**/ ?>
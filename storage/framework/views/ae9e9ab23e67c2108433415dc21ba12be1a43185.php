...
<?php endif; ?>
    ...
    <img src="<?= asset('Assets\adventure\brazil.jpg') ?>"  class="card-img-top custom-page" alt="... ">
    ...
    <p class="custom-page-list-para">
        ...
        <ul class="custom-page-list">
            ...
            <li>Day 1 - Sugarloaf Mountain and Copacana Beach, Rio De Janerio<br>
                <img src="<?= asset('Assets\adventure\Brazil\brazil5.jpg') ?>"  class="custom-page-image">
            </li>

            <li>Day 2 - 8 hour Pedra da Gavea Hike , Rio De Janerio<br>
                <img src="<?= asset('Assets\adventure\Brazil\brazil1.jpg') ?>"class="custom-page-image">
            </li>


            <li>Day 3 - Hang gliding Experience Rotorfly , Rio De Janerio<br>
                <img src="<?= asset('Assets\adventure\Brazil\brazil2.jpg') ?>" class="custom-page-image">
            </li>

            <li>Day 4 - Abseiling , Parasailing and Hot air balooning through Rio Radical<br>
                <img src="<?= asset('Assets\adventure\Brazil\brazil3.jpg') ?>" class="custom-page-image">
            </li>

            <li>Day 5 - Buggy Ride - Genipabu + North Coast to Jacuma <br>
                <img src="<?= asset('Assets\adventure\Brazil\brazil4.jpg') ?>" class="custom-page-image">
            </li>




            <li>During the trip , we would stay at Radisson Hotel Barra , Rio de Janeiro <br>
                <div id="carouselExampleControls" class="carousel slide custom-page-image" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= asset('Assets\adventure\Brazil\brazil6.jpg') ?>"class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets\adventure\Brazil\brazil7.jpg') ?>" class="d-block w-100 custom-page-image" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('Assets\adventure\Brazil\brazil8.jpg') ?>"class="d-block w-100 custom-page-image" alt="...">
                        </div>
                    </div>
    ...
    <p class="custom-page-list-para bottom">
        ...
        <p class="custom-page-div-font bottom ">
            1,30,000 /- INR (Including overall hotel stays , vehicle charges and food at the best restaurants )
...
<?php /**PATH C:\Users\hp\Documents\Laravel\Tourism\resources\views/brazil.blade.php ENDPATH**/ ?>